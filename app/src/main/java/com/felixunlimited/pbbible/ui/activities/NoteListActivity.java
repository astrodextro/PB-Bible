...
import com.felixunlimited.pbbible.ui.fragments.NoteDetailFragment;
...
/**
 * An activity representing a list of SyncUtils. This activity
...
public class NoteListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Util.setTheme(this, R.style.Theme_AppCompat_Light);
        ...
        mScripture = getIntent().getStringExtra(NotePadUtils.ARG_SCRIPTURE);

        if (!NotePadUtils.NOTES_DIR.exists())
            NotePadUtils.NOTES_DIR.mkdirs();
    ...
    public void openNote(String rawNote) {
        if (mTwoPane) {
            ...
            arguments.putString(NotePadUtils.ARG_TWO_PANE, "twoPane");
            arguments.putString(NotePadUtils.ARG_OPEN_NOTE_FROM_LIST, rawNote);
            arguments.putString(NotePadUtils.ARG_SCRIPTURE, mScripture);
            ...
            intent.putExtra(NotePadUtils.ARG_OPEN_NOTE_FROM_LIST, rawNote);
            intent.putExtra(NotePadUtils.ARG_SCRIPTURE, mScripture);
...
//        }
    ...
    public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            Note note = NotePadUtils.getNoteFromFile(NotePadUtils.NOTES_DIR.listFiles()[position]);
            holder.mNote = note;
            if (note != null) {
                holder.mCreatedView.setText("created: "+ NotePadUtils.formatDate(Long.parseLong(note.created)));
                holder.mTitleView.setText(note.title);
                holder.mSpeakerView.setText(note.speaker);
                holder.mContentView.setText(NotePadUtils.firstLine(note.content));
                holder.mModifiedView.setText("edited: "+ NotePadUtils.formatDate(Long.parseLong(note.modified)));
        ...
        public int getItemCount() {
            return NotePadUtils.getCount(NotePadUtils.NOTES_DIR);
        }

...
import com.felixunlimited.pbbible.ui.fragments.BrowseBookFragment;
import com.felixunlimited.pbbible.ui.fragments.BrowseChapterFragment;
import com.felixunlimited.pbbible.ui.fragments.BrowseVerseFragment;

import java.util.ArrayList;
import java.util.List;

public class BrowseBibleActivity extends AppCompatActivity /*implements View.OnClickListener, TextView.OnEditorActionListener*/ /*implements SearchView.OnQueryTextListener*/ {
...
//        NotePadUtils.setTheme(this, R.style.AppBaseTheme_AppCompat_Dialog_Light);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new BrowseBookFragment(), "Books");
        adapter.addFragment(new BrowseChapterFragment(), "Chapters");
        adapter.addFragment(new BrowseVerseFragment(), "Verses");
...
//            finish();
//            startActivity(new Intent(this, BrowseBibleActivity.class));
//        }

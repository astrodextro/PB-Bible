...
import static com.felixunlimited.pbbible.models.Constants.DOCUMENT_FOLDER;
import static com.felixunlimited.pbbible.models.Constants.DOWNLOAD_FOLDER;
import static com.felixunlimited.pbbible.models.Constants.FROM_WIDGET;
import static com.felixunlimited.pbbible.models.Constants.MONTH;
import static com.felixunlimited.pbbible.models.Constants.MONTHLY_THEME;
import static com.felixunlimited.pbbible.models.Constants.PREFERENCE_NAME;
import static com.felixunlimited.pbbible.models.Constants.THEME_SCRIPTURE;
...
//                            displayAlert();
    ...
    public void onCreate() {
        ...
        if (!displayNotifications)
            ...
            createTimerTask();
            paused = false;
            timer.schedule(doAsynchronousTask, 10800000, 10800000);
        }
    }
...
// Creates an explicit intent for an ResultActivity to receive.
        Intent resultIntent = new Intent(this, BiblesOfflineActivity.class);
...
// Adds the back stack for the Intent (but not the Intent itself).
        stackBuilder.addParentStack(BiblesOfflineActivity.class);

package com.felixunlimited.pbbible.utils;
...
//            }
	...
	public static int getBookNo (int chapterIndex) {
		return Integer.parseInt(Constants.arrVerseCount[chapterIndex].split(";")[0]);
	}

	public static int getChapterNo (int chapterIndex) {
		return Integer.parseInt(Constants.arrVerseCount[chapterIndex].split(";")[1]);
	}

	public static int getNoOfVerses (int chapterIndex) {

...
import com.felixunlimited.pbbible.BiblesOffline;
...
class BrowseBibleAdapter extends BaseAdapter {
    private Context mContext;
    private ArrayList<String> mContent;
    private String mFrom;

    BrowseBibleAdapter(Context c, ArrayList<String> mContent, String mFrom) {
        mContext = c;
